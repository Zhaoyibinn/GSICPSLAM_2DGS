...
def depths_to_points(view, depthmap):
    ...
    try:
        grid_x, grid_y = torch.meshgrid(torch.arange(W[0], device='cuda').float(), torch.arange(H[0], device='cuda').float(), indexing='xy')
    except:
        grid_x, grid_y = torch.meshgrid(torch.arange(W, device='cuda').float(),
                                        torch.arange(H, device='cuda').float(), indexing='xy')
